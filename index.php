                ...
                <div class="col-xl-6">
                    <div class="our-package-content">
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-2" data-cursor="-opaque"> One Vision. <br><span>Complete Execution.</span></h2>
                            <p>
                                <strong>MA Vision should be positioned as an execution-led event production partner, not simply a video or
                                    event-coverage vendor.</strong> The website should show that the team can understand the brief, build the production
                                plan, coordinate the moving parts, execute on-ground and create the content generated by the event.
                            </p>
                        </div>

                        <div class="our-package-item-list wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="why-choose-us-box box-1 wow fadeInUp">
                        ...
                        <div class="why-choose-item-image">
                            <figure>
                                <img src="images/why-choose/why-choose-image-1.png" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="why-choose-us-box box-1 wow fadeInUp">
                        ...
                        <div class="why-choose-item-image">
                            <figure>
                                <img src="images/why-choose/why-choose-image-2.png" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="why-choose-us-box box-1 wow fadeInUp">
                        ...
                        <div class="why-choose-item-image">
                            <figure>
                                <img src="images/why-choose/why-choose-image-3.png" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
    ...
    <div class="industries-grid">
        <div class="container">
            ...
            <div class="row">
                <?php foreach (array_slice($industries, 0, 6) as $index => $item): ?>
